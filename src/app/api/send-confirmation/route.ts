  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr><td align="center" class="ew" style="padding:32px 16px;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
        ...
        <!-- Gradient accent bar -->
        <tr>
          <td style="height:3px;background:${GRAD};font-size:0;line-height:0;">&nbsp;</td>
        </tr>

        <!-- Body -->
        <tr>
          <td class="eb" style="padding:28px 32px 24px;">
            <p style="margin:0 0 20px;font-size:16px;font-weight:600;color:#14111C;
                      font-family:${FONT};">
  ...
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: emailHTML({ clientName, businessName, service, professional, date, time, primaryColor, cancelUrl, rescheduleUrl }),
      }),
    });
