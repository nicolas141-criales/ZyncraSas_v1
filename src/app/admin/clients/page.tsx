...
const AVATAR_COLORS = ["#fb0f05","#9B3FC8","#0027fe","#10b981","#f59e0b","#ec4899"];
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ background: "white", border: "1px solid #e8e6e2", borderRadius: "18px", overflow: "hidden" }}>
        {loading ? (
          <div style={{ padding: "60px", textAlign: "center", color: "#a0a0b0", fontSize: "14px" }}>Cargando clientes…</div>
        ) : filtered.length === 0 ? (
          ...
          <div style={{ overflowX: "auto" }}>
            ...
            {filtered.map((c, idx) => (
              ...
              >
                ...
                {/* Email */}
                <span style={{ fontSize: "13px", color: "#6b6b80" }}>{c.email || <span style={{ color: "#d0ceca" }}>—</span>}</span>
